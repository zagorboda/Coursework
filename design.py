...
"")
        ...
        self.line_2.setGeometry(QtCore.QRect(0, 260, 141, 21))
        ...
        self.radio_date = QtWidgets.QRadioButton(self.groupBox)
        self.radio_date.setGeometry(QtCore.QRect(270, 30, 82, 17))
        font = QtGui.QFont()
        font.setPointSize(10)
...
"border-radius:5px;")
        ...
        self.get_info_date = QtWidgets.QFrame(self.get_info_direction)
        self.get_info_date.setGeometry(QtCore.QRect(-1, -1, 641, 341))
        self.get_info_date.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.get_info_date.setFrameShadow(QtWidgets.QFrame.Raised)
        self.get_info_date.setObjectName("get_info_date")
        self.label_5 = QtWidgets.QLabel(self.get_info_date)
        self.label_5.setGeometry(QtCore.QRect(40, 20, 81, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_5.setFont(font)
        self.label_5.setObjectName("label_5")
        self.date_input = QtWidgets.QLineEdit(self.get_info_date)
        self.date_input.setGeometry(QtCore.QRect(140, 30, 113, 20))
        self.date_input.setStyleSheet("border:1px solid;")
        self.date_input.setObjectName("date_input")
        self.find_info_date_btn = QtWidgets.QPushButton(self.get_info_date)
        self.find_info_date_btn.setGeometry(QtCore.QRect(40, 70, 75, 23))
        font = QtGui.QFont()
        font.setPointSize(10)
...
"border-radius:5px;")
        ...
        self.date_input_error = QtWidgets.QLabel(self.get_info_date)
        self.date_input_error.setGeometry(QtCore.QRect(300, 30, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.date_input_error.setFont(font)
        self.date_input_error.setStyleSheet("color:orange;")
        self.date_input_error.setText("")
        self.date_input_error.setObjectName("date_input_error")
        self.flight_info_by_date_list = QtWidgets.QListWidget(self.get_info_date)
        self.flight_info_by_date_list.setGeometry(QtCore.QRect(40, 110, 581, 192))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radio_date.setText(_translate("MainWindow", "Date"))
